package com.hau.huylong.graduation_proejct.config.aop;
...
public class LoggingAspect {
    ...
    @Around("execution(* com.hau.huylong.graduation_proejct.service..*(..)))")
    ...
    @Around("execution(* com.hau.huylong.graduation_proejct.repository..*(..)))")
